...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active"><a href="http://localhost:8080/Minion's%20Final/clientLogin.php"><span class="glyphicon glyphicon-log-in"></span> Client Login</a></li>
        </ul>
    </div>
</nav>
<?php
...
<div id="main-content">
    <div class="container">
        <h1 class="col-sm-offset-2 col-sm-10"> Client Login </h1>
        <form method="post" class="form-horizontal">

            <! --Email Field -->
            <div class="form-group">
                <label class="control-label col-sm-2" for="identifiant"> Email Address:</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="identifiant" value="<?=get_input('identifiant')?>" name="identifiant" tabindex="1" required="required" autocomplete="off"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="password" class="form-control" id="password" name="password" tabindex="1" required="required" autocomplete="off"/>
                </div>
            </div>
